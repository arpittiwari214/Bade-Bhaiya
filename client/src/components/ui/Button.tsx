...
const VARIANTS: Record<Variant, string> = {
  ...
  secondary:
    'bg-surface text-slate-800 ring-1 ring-slate-300 hover:bg-slate-50 active:bg-slate-100 dark:bg-slate-900 dark:text-slate-100 dark:ring-slate-700 dark:hover:bg-slate-800',
  ghost:
